...
description: Tulis dan compile makalah LaTeX dua format — artikel IEEE 2-kolom (IEEEtran, sitasi numeric) dan makalah akademik UIN 1-kolom (Times 12pt, footnote skripsi-grade). Use when user asks to write, revise, compile, optimize, verify, or troubleshoot a paper/makalah/artikel, mentions IEEE, UIN, template-makalah, template-ieee, pdflatex, bibtex, sitasi, footnote, cover page, kata pengantar, daftar pustaka, or needs build.ps1 scripts.
---
...
- Terapkan aturan format sejak awal — lihat `references/format-ieee.md` atau `references/format-makalah-uin.md`.
...
Untuk IEEE pakai `assets/template-ieee/build.ps1` (4-pass dengan bibtex).
